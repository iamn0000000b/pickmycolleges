...
@section('title') {{ __('View Article') }} @endsection
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">{{ __('View Article') }}</h3>
                        ...
                        <table class="table table-bordered table-striped">
                            <tbody>
                                ...
                                <tr>
                                    <th>{{ __('Action') }}</th>
                                    <td>
                                        <a class="btn btn-sm btn-primary" href="{{ route('admin.articles.edit', $article->id) }}" title="{{ __('Edit') }}"><i class="fas fa-edit"></i></a>
