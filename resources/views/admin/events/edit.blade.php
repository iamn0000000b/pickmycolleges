                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="goal_id" id="goal_id" class="form-control select2" style="width:100%;">
                                            ...
                                            @foreach($goals as $id => $goal)
                                                <option value="{{ $id }}" {{ ($id == old('goal_id', $event->goal_id)) ? 'selected' : '' }}>
                                                    {{ $goal }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="title" id="title" value="{{ old('title', $event->title) }}">
                                    </div>

                                    <div class="form-group">
                                      <label>{{ __('Description') }} <span class="text-danger">*</span></label>
                                      <textarea name="description" id="summernote">{{ old('description', $event->description) }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      ...
                                      @if(!empty($event->image))
                                        <p><img src="{{ $event->image_url }}" alt="" class="img-responsive mt-1"></p>
                                      @endif
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input type="text" name="exam_date" class="form-control pull-right" id="datepicker" value="{{ old('exam_date', $event->exam_date) }}" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input type="text" name="application_last_date" class="form-control pull-right" id="datepicker2" value="{{ old('application_last_date', $event->application_last_date) }}" autocomplete="off">
                                            <div class="input-group-text input-group-addon">
                                                <i class="fa fa-calendar"></i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="tab-content mt-1">
                                            <div class="active tab-pane" id="info">
                                                <textarea name="exam_info" id="summernote1">{{ old('exam_info', $event->exam_info) }}</textarea>
                                            </div>
                                            
                                            <div class="tab-pane" id="dates">
                                                <textarea name="exam_dates" id="summernote2">{{ old('exam_dates', $event->exam_dates) }}</textarea>
                                            </div>

                                            <div class="tab-pane" id="highlight">
                                                <textarea name="exam_highlight" id="summernote3">{{ old('exam_highlight', $event->exam_highlight) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
