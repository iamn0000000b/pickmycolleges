...
@section('title') {{ __('Edit Exam') }} @endsection
            ...
            <div class="col-md-12">
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title">{{ __('Edit Exam') }}</h3>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="exam_category_id" id="exam_category_id" class="form-control select2" style="width:100%;">
                                            ...
                                            @foreach($exam_categories as $id => $exam_category)
                                                <option value="{{ $id }}" {{ ($id == old('exam_category_id', $exam->exam_category_id)) ? 'selected' : '' }}>
                                                    {{ $exam_category }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <textarea name="description" id="summernote">{{ old('description', $exam->description) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
